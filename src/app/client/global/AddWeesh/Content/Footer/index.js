  ...
  return (
    <StyledContainer>
        ...
        <StyledComponents.Share.Container>
          {shareOptions.map(item => (
            <StyledComponents.Share.Item
              ...
              <Icon icon={item.icon} color={auth.color} size={30} />
      ...
      <Button
        ...
        isLoading={
          (isAddType ? addWeeshResponse.loading : editWeeshResponse.loading) ||
          undefined
        }
        padding=".5rem 1rem"
        radius="50rem">
        ...
        <Icon icon={isAddType ? "PenTool" : "Edit"} color="background" />
      </Button>
    </StyledContainer>
  );
};
