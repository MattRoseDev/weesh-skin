...
export default (props) => {
    ...
    const { data, called, error, loading } = useQuery(api.weeshBookmarks.getUserBookmarksWeeshes,{
    ...
    return auth.username ? <StyledContainer>
        ...
        {!loading && (bookmark && !bookmark.weeshesBookmark) && <BannerMessage padding='3rem 0' icon='Hash' title={C.txts.en.g.noWeeshesYet} />}
    </StyledContainer> : ''
}
