...
export default (props) => {
    ...
    return <StyledRightSide>
        ...
        <DrawerDialog width='100%' buttons={buttons} {...drawerDialog} toggleDialogFunction={(visible) => toggleDrawerDialog(visible)}/> 
        <Dialog width='65%' {...dialog} toggleDialogFunction={(visible) => toggleDialog(visible)}>
            <StyledHeaderDialog>
