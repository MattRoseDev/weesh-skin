...
export default props => {
  ...
  return (
    <StyledContainer>
      ...
      <Link to={props.url}>
        <StyledIcon>{switchIcon(props.notificationType.type)}</StyledIcon>
      </Link>
    </StyledContainer>
  );
};
...
const switchIcon = type => {
  switch (type) {
    ...
    case "comment_weesh":
      return (
        <Icon icon="MessageCircle" size={20} strokeWidth={1.5} color="dark" />
      );
    case "reply_comment":
      return (
        <Icon icon="CornerUpRight" size={20} strokeWidth={1.5} color="dark" />
      );
    ...
    case "mention_in_weesh":
      return <Icon icon="AtSign" size={20} strokeWidth={1.5} color="dark" />;
    case "reweesh":
      return <Icon icon="Repeat" size={20} strokeWidth={1.5} color="dark" />;
  }
};
      ...
      case "$$comment$$":
        return (
          <StyledContent key={uuid()}>
            {props.comment && `${props.comment.content.replace(/\n/g, " ")} `}
          </StyledContent>
        );
      case "$$you$$":
        return (
